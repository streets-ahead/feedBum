...
TestFeed = new FeedBum(FeedBum.RSS2);
...
TestFeed.setImage('Testing & Checking the RSS writer class','http://www.ajaxray.com/projects/rss','http://www.rightbrainsolution.com/images/logo.gif');
...
newItem.addElement('guid', 'http://www.ajaxray.com', {'isPermaLink' : 'true'});
...
// newItem = TestFeed.createNewItem();
// newItem.addElementArray( {'title':'The 2nd feed', 'link':'http://www.google.com', 'description':'This is test of feedwriter class'});
// TestFeed.addItem(newItem);
